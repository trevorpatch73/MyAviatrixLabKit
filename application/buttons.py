...
def Launch_Lab1_Aviatrix():
    ...
    for object in objects:
        if '"@message":"Outputs:' in object:
            ...
            environment.db_aws_us_e2_shr_svcs_vpc_id = aws_us_e2_shr_svcs_vpc_id[0]
            db.session.commit()
            ...
            environment.db_aws_us_w2_bu1_mono_subnet_id = aws_us_w2_bu1_mono_subnet_id[0]
            db.session.commit()
            ...
            environment.db_aws_us_w2_bu1_mono_vpc_id = aws_us_w2_bu1_mono_vpc_id[0]
            db.session.commit()
